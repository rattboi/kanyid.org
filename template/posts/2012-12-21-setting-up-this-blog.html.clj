...
(p "Now that I had a Debian box on the Internet, I needed to figure out how to set up a web server, and also a way to manage my web content. I had a little experience setting up Apache Web Server before, but that seemed pretty heavy and overkill for what I was trying to do. The only alternative I'd heard commonly thrown around was nginx, which I had never used myself. ")
